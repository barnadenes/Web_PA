...
A word of warning: Gantz is not for the faint-hearted, but neither is it as simple as it looks. Gore, rape, and violence is rampant, as are portrayals of greed, violence, and all the ugliness that one sees in society today.', 15),
    ('Gintama', 'Hideaki Sorachi', 'https://vignette.wikia.nocookie.net/gintama/images/b/b0/Gintama_Episode_11.png', 'With even more dirty jokes, tongue-in-cheek parodies, and shameless references, Gintama'' follows the Yorozuya team through more of their misadventures in the vibrant, alien-filled world of Edo.', 20),
